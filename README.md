...
У роботі реалізовано веб-додаток з CRUD-функціоналом для трьох таблиц: полів, посівів та польових робіт. Реалізовано за допомогою React, TanStack Query, TanStack Router та React Hook Form з валідацією через Zod.
