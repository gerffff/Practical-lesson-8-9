...
1. Обробка різноманітних форматів відповідей API
Була проблема з тим, що API може повертати дані різними способами:
Прямий масив: [{...}, {...}]
Об'єкт з полем data: { data: [{...}, {...}] }
Об'єкт з повідомленням: { message: "...", data: {...} } 

Це було вирішено шляхом додавання обробки усіх необхідних форматів у функціях отримання даних
2. Заповнення форм редагування даними
Поля форм редагування не заповнювались автоматично при завантаженні даних з API.
Рішення: Використано проп values в useForm замість reset в useEffect. Це дозволяє реактивно оновлювати форму при зміні даних
